...
##Desarrollo:##
#1- Instalar Git#
Los pasos y referencias asumen el uso del sistema operativo Windows, en caso otros
SO seguir recomendaciones específicas.
...
? Instalar Notepad ++ para Windows o TextMate para Mac OS, colocarle un alias y
configurarlo como editor predeterminado
#4- Creación de Repos 01 -> Crearlo en GitHub, clonarlo localmente y subir
cambios#
...
?
??
En caso de ser necesario configurar las claves SSH requeridas y reintentar el
push.
?
?
?
...
??Cambiarse a
la rama main e
intentar mergear con la rama conflictBranch
